...
function InNewsPresentationCard({ imageUrl, name, ...rest }) {
  return (
    <Card
      {...rest}
      sx={{
    ...
    >
      ...
      <MKBox pt={3} px={3} mt={-1} textAlign="center">
...
InNewsPresentationCard.propTypes = {
  imageUrl: PropTypes.string.isRequired,
  name: PropTypes.string.isRequired,
};
export default InNewsPresentationCard;
